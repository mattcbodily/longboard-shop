...
const GripDisplay = (props) => {
    return (
        <div className='custom-parts-card' onClick={(e) => props.selectPart(e, props.part.part_name, `https://s3-us-west-1.amazonaws.com/old-dog-new-trick-longboards-bucket/${props.design.name}_${props.part.part_name}.png`, props.part.price)}>
            <div>
